  ...
  <div class="min-h-full">
    ...
    <div class="container max-w-screen-lg mt-12 space-y-12">
      <div class="flex items-center space-x-4">
        ...
        <h1 class="text-3xl font-semibold">Editing event</h1>
      </div>
...
<script setup>
  ...
  function submit() {
    ...
    events.value[eventIndex] = JSON.parse(JSON.stringify(event.value));
  }

  onMounted(() => {
    event.value = events.value.find((event) => event.id == id);
  });
</script>
